...
const display = () => { 
  ...
  // очистка fruitsList от вложенных элементов, чтобы заполнить актуальными данными из fruits
  fruitsList.innerHTML = null; 
  
  // формирование нового элемента <li> при помощи document.createElement, и добавление в конец списка fruitsList при помощи document.appendChild
...
archiveArr = fruits.slice(); // сохранение резервной копии основного массива для восстановления при отмене операций. Например, сброс фильтра.
display(); 
...
let priority = ['розовый', 'пурпурный', 'фиолетовый', 'синий', 'лазурный', 'голубой', 'ярко-зеленый', 'бледно-зеленый', 'зеленый', 'желтый', 'оранжевый','красный'];
...
// переключение значения sortKind между 'bubbleSort' / 'quickSort' при нажатии на кнопку
...
// выполняет сортировку и производит замер времени при нажатии на кнопку
